...
# Cleaning post setup
apt remove --purge -y checkinstall build-essential cmake g++ libsystemd-dev libcurl4-openssl-dev libpam0g-dev libbpf-dev libelf-dev clang zlib1g-dev pkg-config dwarves bpftool
